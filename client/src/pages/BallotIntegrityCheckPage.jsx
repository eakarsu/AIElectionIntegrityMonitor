...
export default function BallotIntegrityCheckPage() {
  const [form, setForm] = useState({ state: '', county: '', election_year: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (form.election_year.trim()) payload.election_year = parseInt(form.election_year, 10);
      const data = await ai.ballotIntegrityCheck(payload);
      setResult(data);
    } catch (err) {
    ...
    <div className="animate-in">
      <div className="data-table-container" style={{ marginBottom: 20 }}>
        <div className="table-header">
          <h2>🗳️ Ballot Integrity Check</h2>
        </div>
        <div style={{ padding: 24 }}>
          <p style={{ color: 'var(--text-light)', marginBottom: 16 }}>
            Run AI anomaly detection across precinct-level ballot counts.
          </p>
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              <div className="form-group">
                <label>Election Year (optional)</label>
                <input
                  type="number"
                  value={form.election_year}
                  onChange={(e) => setForm({ ...form, election_year: e.target.value })}
      ...
      {loading && (
        <div className="ai-analysis-container">
          ...
          <div className="ai-loading">
            ...
            Generating ballot integrity analysis...
          </div>
        </div>
      )}
          ...
          <div style={{ padding: 24 }}>
            <div className="detail-grid" style={{ marginBottom: 20 }}>
              ...
              <div className="detail-item">
                ...
                <div className="detail-value">{result.election_year || 'All'}</div>
              </div>
              <div className="detail-item">
